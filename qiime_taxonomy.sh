...
qiime feature-classifier classify-sklearn --i-classifier /home/nathan.hicks/silva_database/silva-138-99-341F-785R-classifier.qza --i-reads $outputSeqs --o-classification $outputTax --p-reads-per-batch 2000
